        ...
        return (
            <div id='menu' className='primary-color pb2'>
                <div className='inner-container border-dotted bottom mb2'>
                    <h2>Menu</h2>
                    {categories.map(category => <Category category={category} disabled={this.props.disabled} key={'cat-' + category.id} cartAction={this.cartAction} showCart={this.props.showCart} />)}
                </div>
            </div>
        );
    }
